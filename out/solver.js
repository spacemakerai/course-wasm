...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5258624,
    DYNAMIC_BASE = 5258624,
    DYNAMICTOP_PTR = 15712;
...
var wasmBinaryFile = 'out/solver.wasm';
...
var real__move = asm["_move"];
asm["_move"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__move.apply(null, arguments);
};
...
var _move = Module["_move"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_move"].apply(null, arguments)
};
